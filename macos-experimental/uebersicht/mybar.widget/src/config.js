...
export const renderOrder = '|A|B|W-S-T';
...
export const config = {
    ...
    Time: {
        ...
        colors: { 'w': '#D8DEE9', 'm': '#E5E9F0', 'D': '#ECEFF4', 'H': '#aba', 'p': '#898', 's': '#676', '?':'#A3BE8C'}
    },
    // === Command: 'W' === //
    Wifi: {
        ...
        filledColors: Settings.WifiStyle.Color.RAINBOW,
